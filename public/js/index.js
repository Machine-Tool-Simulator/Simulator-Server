...
window.onload = function() {
    ...
    doonebutton.addEventListener('click', function() {
        ...
        selectedCoord = 0;
		getById('f1').value = 'TAPER';
		getById('f2').value = 'RADIUS';
		getById('f3').value = 'FILLET';
		getById('f4').value = '';
		getById('f5').value = 'THREAD REPAIR';
		getById('f6').value = '';
		getById('f7').value = '';
				getById('f8').value = 'RETURN';
				dooneSelected = 1;
    });
...
function resetfunctionbutton() {
	getById('f1').value = '';
	getById('f2').value = 'POWER FEED';
	getById('f3').value = 'DO ONE';
	getById('f4').value = 'GO TO';
	getById('f5').value = 'MAX RPM';
	getById('f6').value = 'RETURN HOME';
	getById('f7').value = 'SPIN SPEED';
	getById('f8').value = 'TOOL #';
	gotoSelected = 0;
	dooneSelected = 0;
	powerfeedSelected = 0;
}
...
getById('timer').innerHTML = '20:05';
startTimer();

function startTimer() {
  var presentTime = getById('timer').innerHTML;
